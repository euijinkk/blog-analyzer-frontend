...
import { ArrowLeftIcon, ShareIcon, DownloadIcon, RefreshCwIcon } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white flex items-center justify-center">
        <div className="text-center p-8 max-w-md">
          ...
          <div className="flex gap-4 justify-center">
            <button onClick={() => refetch()} className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition">
              다시 시도
            </button>
      ...
      <main className="min-h-screen w-full pb-20">
        <header className="bg-white shadow-sm sticky top-0 z-10">
          <div className="max-w-5xl mx-auto px-4 py-4 flex justify-between items-center">
            <button onClick={handleBackToHome} className="flex items-center text-gray-700 hover:text-indigo-600 transition">
          ...
          <div className="mb-12 text-center">
            ...
            {blogUrl && (
              <div className="mt-2 text-sm text-gray-500">
                <span>분석 대상: </span>
                <a href={blogUrl} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">
                  {blogUrl}
                </a>
              </div>
            )}
