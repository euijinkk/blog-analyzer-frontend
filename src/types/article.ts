...
> = {
  nightMorning: { leftIcon: "🌙", leftLabel: "밤형", rightIcon: "☀️", rightLabel: "아침형" },
  narrativeImpact: { leftIcon: "📖", leftLabel: "서사형", rightIcon: "⚡", rightLabel: "임팩트형" },
  trendEssence: { leftIcon: "🔥", leftLabel: "트렌드형", rightIcon: "💎", rightLabel: "본질형" },
  communicationUnilateral: { leftIcon: "💬", leftLabel: "소통형", rightIcon: "📣", rightLabel: "일방형" },
  completeGrowth: { leftIcon: "🏆", leftLabel: "완성형", rightIcon: "🌱", rightLabel: "성장형" },
};
