...
export function QuotesSection({
  ...
  return <section className="bg-white rounded-3xl p-8 shadow-lg">
      ...
      <div className="space-y-6">
        {quotes.map((quoteItem, index) => <div key={index} className="bg-gray-50 rounded-2xl p-6 relative">
            <QuoteIcon className="absolute top-4 left-4 text-gray-300" size={24} />
            <div className="ml-6">
              ...
              <a href={quoteItem.source_link} target="_blank" rel="noopener noreferrer" className="text-indigo-600 text-sm flex items-center hover:underline">
                <span>원문 보기</span>
